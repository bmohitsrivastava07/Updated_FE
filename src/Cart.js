...
const Cart = (props) => {
    ...
    const check = () => {
        if(isEmpty) {return <> <h1>nope!!!!1</h1> </>}    
        Swal.fire({
            title: "Success",
        ...
        <>
            ...
            <section className="py-4 container">
                <div className="row justify-content-center">
                    ...
                    <div className="col-auto"><button className="btn btn-danger m-2" onClick={clearCart}>Clear Cart</button></div>
                    <button className="btn btn-primary" onClick={check}>Buy Now</button>
                </div>
            </section>
            <Footer />
        </>
